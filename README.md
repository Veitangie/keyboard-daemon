...
> **GNOME Note:** GNOME Wayland strictly uses XKB layout shortcodes (e.g., `us`, `ru`, `fr`) instead of full display names. If you use GNOME, pass `'us'` instead of `'en'` to correctly map your layouts!
